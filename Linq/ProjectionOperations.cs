...
namespace Linq
{
    ...
    public static class ProjectionOperations
    {
        ...
        public static IEnumerable<string> TransformWithSelect()
        {
            ...
            var i = 0;
            return numbers.Select(x => strings[numbers[i++]]);
        }
        ...
        public static IEnumerable<(string upper, string lower)> SelectByCase()
        {
            ...
            return words.Select(x => (x.ToUpper(System.Globalization.CultureInfo.CurrentCulture), x.ToLower(System.Globalization.CultureInfo.CurrentCulture)));
        }
        ...
        public static IEnumerable<(string digit, bool even)> SelectEvenOrOddNumbers()
        {
            ...
            var i = 0;
            return strings.Select(x => (strings[numbers[i]], numbers[i++] % 2 == 0));
        }
        ...
        public static IEnumerable<(string productName, string category, decimal price)> SelectPropertySubset()
        {
            ...
            return products.Select(x => (x.ProductName, x.Category, x.UnitPrice));
        }
        ...
        public static IEnumerable<(int number, bool inPlace)> SelectWithIndex()
        {
            ...
            var i = 0;
            return numbers.Select(x => (numbers[i], numbers[i] == i++));
        }
        ...
        public static IEnumerable<string> SelectWithWhere()
        {
            ...
            return numbers.Where(x => x < 5).Select(x => digits[x]);
        }
        ...
        public static IEnumerable<(string customerId, int orderId, string orderDate)> SelectManyWithWhere()
        {
            ...
            var orders =
                ...
                select (customer.CustomerId, order.OrderId, order.OrderDate.ToString("dd-MMM-yy", System.Globalization.CultureInfo.InvariantCulture));
        ...
        public static IEnumerable<string> IndexedSelectMany()
        {
            ...
            return customers.SelectMany((x, y) => x.Orders.Select(z => "Customer #" + (y + 1) + " has an order with OrderID " + z.OrderId));
        }
    }
}
