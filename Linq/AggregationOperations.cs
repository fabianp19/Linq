...
namespace Linq
{
    ...
    public static class AggregationOperations
    {
        ...
        public static IEnumerable<(string category, int productCount)> ProductsInCategoryCount()
        {
            ...
            return products.GroupBy(x => x.Category).Select(x => (x.Key, x.Count()));
        }
        ...
        public static int SumByLength()
        {
            ...
            var i = 0;
            return words.Sum(x => words[i++].Length);
        }
        ...
        public static IEnumerable<(string category, int totalUnitsInStock)> TotalUnitsInStock()
        {
            ...
            return products.GroupBy(x => x.Category).Select(x => (x.Key, x.Sum(y => y.UnitsInStock)));
        }
        ...
        /// </summary>
        /// <returns>The shortest word in array.</returns>
        ...
        public static double Aggregate()
        {
            ...
            return doubles.Aggregate((numbersOfElement, element) => numbersOfElement * element);
        }
        ...
        public static double SeededAggregate()
        {
            ...
            return attemptedWithdrawals.Aggregate(startBalance, (balance, elementInArray) =>
            (balance >= elementInArray) ? (balance - elementInArray) : balance);
        }
    }
}
